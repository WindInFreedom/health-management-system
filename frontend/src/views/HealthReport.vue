    ...
    <el-card class="header-card">
      <div class="header-content">
        ...
        <div class="actions">
          ...
          <el-button @click="exportReport" :disabled="!reportData">
            导出PDF
          </el-button>
...
const renderRadarChart = () => {
  ...
  const data = [
    {
      value: [
        stats.weight?.latest ? (stats.weight.latest / 100 * 100) : 50,
        stats.blood_pressure?.latest_systolic ? (stats.blood_pressure.latest_systolic / 180 * 100) : 50,
        stats.blood_pressure?.latest_diastolic ? (stats.blood_pressure.latest_diastolic / 120 * 100) : 50,
        stats.heart_rate?.latest ? (stats.heart_rate.latest / 120 * 100) : 50,
        stats.blood_glucose?.latest ? (stats.blood_glucose.latest / 15 * 100) : 50
      ],
      name: '当前状态'
    }
  ]
