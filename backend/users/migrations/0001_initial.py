    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '管理员'), ('doctor', '医生'), ('user', '普通用户')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.CharField(help_text='用药频率，例如: 每日3次', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', '男'), ('F', '女'), ('O', '其他')], help_text='性别', max_length=1, null=True)),
                ('blood_type', models.CharField(choices=[('A', 'A型'), ('B', 'B型'), ('AB', 'AB型'), ('O', 'O型'), ('UNKNOWN', '未知')], default='UNKNOWN', help_text='血型', max_length=10)),
                ('height_cm', models.DecimalField(blank=True, decimal_places=1, help_text='身高 (cm)', max_digits=5, null=True)),
                ('weight_baseline_kg', models.DecimalField(blank=True, decimal_places=1, help_text='基准体重 (kg)', max_digits=5, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality_rating', models.IntegerField(blank=True, help_text='睡眠质量评分 (1-10)', null=True)),
                ('notes', models.TextField(blank=True, help_text='备注')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
